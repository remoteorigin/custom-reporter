...
class SpecReporter extends events.EventEmitter {
    constructor (baseReporter, config, options = {}) {
        ...
        this.specs = {}
        this.results = {}
        this.timeMeasure = getTimeMeasure
        ...
        this.on('test:start', (test) => {
            console.log('------------------------------------------------------------------\n')
            console.log(this.chalk.bold(test.title),'\n')
        ...
        this.on('test:end', (test) => {
            ...
            console.log('\nTest case finished in', this.chalk.yellow(this.timeMeasure.result(), '\n'))
        })
